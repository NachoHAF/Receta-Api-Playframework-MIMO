...
create table authors (
  id_author                     bigint auto_increment not null,
...
create table recipes (
  id_recipe                     bigint auto_increment not null,
...
alter table authors drop constraint if exists fk_authors_author_profile_id_profile;

alter table recipes drop constraint if exists fk_recipes_category_id_category;
drop index if exists ix_recipes_category_id_category;

alter table recipes drop constraint if exists fk_recipes_author_id_author;
...
drop table if exists authorprofiles;
